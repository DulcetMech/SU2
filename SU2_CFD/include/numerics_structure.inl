...
inline void CSourcePieceWise_TurbDES97::SetIntermittency(double intermittency_in) { intermittency = intermittency_in; }

inline void CSourcePieceWise_TurbDES97::SetProduction(double val_production) { Production = val_production; }

inline void CSourcePieceWise_TurbDES97::SetDestruction(double val_destruction) { Destruction = val_destruction; }

inline void CSourcePieceWise_TurbDES97::SetCrossProduction(double val_crossproduction) { CrossProduction = val_crossproduction; }

inline double CSourcePieceWise_TurbDES97::GetProduction(void) { return Production; }

inline double CSourcePieceWise_TurbDES97::GetDestruction(void) { return Destruction; }

inline double CSourcePieceWise_TurbDES97::GetCrossProduction(void) { return CrossProduction; }
