...
class CTurbDES97Solver: public CTurbSolver {
private:
	double nu_tilde_Inf;
...
public:
	 ...
	 * \param[in] config - Definition of the particular problem.
	 */
	CTurbDES97Solver(CGeometry *geometry, CConfig *config, unsigned short iMesh);
