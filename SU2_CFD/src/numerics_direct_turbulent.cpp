...
CSourcePieceWise_TurbDES97::~CSourcePieceWise_TurbDES97(void) {
  delete SAInputs;
  delete SAConstants;
  delete testResidual;
  delete testJacobian;
...
void CSourcePieceWise_TurbDES97::ComputeResidual(double *val_residual, double **val_Jacobian_i, double **val_Jacobian_j, CConfig *config) {
